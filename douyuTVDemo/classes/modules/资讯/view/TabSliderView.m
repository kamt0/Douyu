...
- (void)buttonClickStyle:(UIButton *)button{
    ...
    [button setTitleColor:DEDAULT_COLOR forState:UIControlStateNormal];
...
- (void)buttonAction:(UIButton *)sender{
    ...
    for (UIButton *button in self.buttonArray) {
        ...
        if (button != sender) {
            ...
            self.selectIndexBlcok(_selectIndex);
...
-(UIView *)lineView{
    ...
    if (_lineView == nil) {
        ...
        _lineView.backgroundColor = DEDAULT_COLOR;

//
//  NewsPictureScrollViewController.m
//  douyuTVDemo
//
...
@interface NewsPictureScrollViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UIScrollViewDelegate,UIGestureRecognizerDelegate,MBProgressHUDDelegate>
@property (nonatomic , strong) UICollectionView *collectionView; //集合视图

@property (nonatomic , strong) UIView *topView; //顶部透明视图

@property (nonatomic , strong) UIView *bottomView; //底部透明视图
...
@property (nonatomic , strong) UILabel *pageLable;  //显示页码
...
@property (nonatomic, strong) UIImage *saveImage; //保存的图片

@end

static NSString * cellIdentifier = @"Picture_Scroll_Cell";

@implementation NewsPictureScrollViewController
...
- (void)addCollectionView{
    ...
    [_collectionView registerClass:[Picture_Scroll_Cell class] forCellWithReuseIdentifier:cellIdentifier];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    Picture_Scroll_Cell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellIdentifier forIndexPath:indexPath];
...
- (void)loadTopBottomView{
    ...
    _backButton.frame = CGRectMake(0, 10 , 80 , 44);
    ...
    _saveButton.frame = CGRectMake(CGRectGetWidth(_topView.frame) - 80 , 10 , 80 , 44);
    
    _saveButton.tintColor = [UIColor whiteColor];
    
    [_saveButton setImage:[[UIImage imageNamed:@"xiazaiimage"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateNormal];
...
- (void)setPictureString:(NSString *)pictureString{
    ...
    if ( _pictureString != pictureString) {
...
- (void)loadData{
    ...
    NSString *url = [self.pictureString stringDecode];
...
- (void)JSONSerializationWithData:(id)data{
    ...
    if (data != nil) {
        ...
        for (NSDictionary *dic in array){
            ...
            Picture_Scroll_Model *model = [[Picture_Scroll_Model alloc]init];
...
- (void)saveImageAction{
    ...
    Picture_Scroll_Model *model = [self.pictureArray objectAtIndex:_itemIndex];

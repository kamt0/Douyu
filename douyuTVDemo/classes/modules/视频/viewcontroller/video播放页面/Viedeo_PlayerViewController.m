...
@interface Viedeo_PlayerViewController ()<UIGestureRecognizerDelegate>

//视频播放控制器

@property (nonatomic , strong ) MyMoviePlayerController *moviePlayer;
...
@property (nonatomic , strong ) UIView *topView;//顶部控制视图

@property (nonatomic , strong ) UIView *bottomView;//底部控制视图

@property (nonatomic , strong ) UIButton *topBackButton;//顶部返回按钮

@property (nonatomic , strong ) UILabel *topTitleLabel;//顶部标题Label

@property (nonatomic , strong ) UIButton *topDefinitionButton;//顶部清晰度切换按钮

@property (nonatomic , strong ) UIView *topDefinitionListView;//顶部清晰度列表视图

@property (nonatomic , strong ) UIButton *playButton;//播放按钮

@property (nonatomic , strong ) UISlider *slider;//播放进度条滑块

@property (nonatomic , strong ) UIProgressView *progressView;//缓冲进度条视图

@property (nonatomic , strong ) UILabel *playTimeLabel;//播放时间Label

@property (nonatomic , strong ) UILabel *videoDurationLabel;//视频时长Label


@property (nonatomic , strong ) UIView *volumeView;//音量视图

@property (nonatomic , strong ) UISlider *volumeSlider;//侧边音量滑块
...
@property (nonatomic , strong ) UIView *promptView;//缩进快进提示视图

@property (nonatomic , strong ) UILabel *promptValueLabel;//提示滑动的值

@property (nonatomic , strong ) UILabel *promptTimeLabel;//提示时间Label
...
@implementation Viedeo_PlayerViewController
...
-(void)loadBottomView{
    ...
    _slider.minimumTrackTintColor = DEDAULT_COLOR;
...
-(void)loadVolumeView{
    ...
    _volumeSlider.minimumTrackTintColor = DEDAULT_COLOR;
...
- (void)showControlView{
    ...
    __block Viedeo_PlayerViewController *Self = self;
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [[SingTonManger sharedSingTonManger] downloadViewHiddenOrShow:YES];
...
-(void)viewDidDisappear:(BOOL)animated{
    ...
    [[SingTonManger sharedSingTonManger] downloadViewHiddenOrShow:NO];
...
-(NSURL *)getNetworkUrl{
    ...
    VideoDetailModel *VDModel = self.videoArray[self.definitionIndex];
...
-(NSTimer *)timer{
    ...
    if (_timer == nil) {
        ...
        _timer = [NSTimer timerWithTimeInterval:1.0f target:self selector:@selector(playTimerAction:) userInfo:nil repeats:YES];
        
        //将定时器添加VideoDetailModel到运行循环中
...
-(MPMoviePlayerController *)moviePlayer{
    ...
    if (!_moviePlayer) {
        ...
        _moviePlayer=[[MyMoviePlayerController alloc]init];

...
@interface globalView ()<UIDynamicAnimatorDelegate>
...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        _backgroundView.backgroundColor = [DEDAULT_COLOR colorWithAlphaComponent:0.7];
        ...
        imageBackgroundView.backgroundColor = [DEDAULT_COLOR colorWithAlphaComponent:0.8f];
        ...
        _imageView = [[UIImageView alloc]initWithImage:[[UIImage imageNamed:@"btn_live"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate]];

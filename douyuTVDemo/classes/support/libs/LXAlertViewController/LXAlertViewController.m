...
@property (nonatomic , strong ) UIView *titleHolder;//标题持有视图

@property (nonatomic , strong ) UIView *positiveView;//确定视图

@property (nonatomic , strong ) UIView *negativeView;//否定视图

@property (nonatomic , strong ) UIButton *cancelButton;//关闭按钮

@property (nonatomic , strong ) UILabel *titleLabel;//提示Label

@property (nonatomic , strong ) UILabel *positiveLabel;//确定按钮Label

@property (nonatomic , strong ) UILabel *negativeLabel;//否定按钮Label
...
-(void)dealloc{
    ...
    _againAlertTitle   = nil;

    _negativeTitle     = nil;

    _positiveTitle     = nil;

    _successAlertTitle = nil;
